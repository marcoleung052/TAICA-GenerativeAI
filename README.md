...
| 4 | 文字生成 AI 與大型語言模型 | 建立自己的benchmarks | [hw4]( "游標顯示") |  |
| 5 | RNN 及 transformers的數學原理 | 探索並應用一個提示工程技巧 | [hw5]( "游標顯示") |  |
| 6 | 大型語言模型（LLM）的應用及倫理議題的挑戰 | 用 OpenAI API 打造自己的對話機器人 | [hw6]( "游標顯示") |  |
| 7 | 打造自己的對話機器人 | 打造自己的 RAG 強化的對話機器人 | [hw7]( "游標顯示") |  |
| 8 | 檢索增強生成（RAG）的原理及實作 | - |  |  |
| 9 | 專家講座 業界專家分享 RAG 在金融上的應用與挑戰 | 【AI Agents】打造你專屬的超級代理人 | [hw9]( "游標顯示") |  |
| 10 | Agentic AI 與 AI Agents | 利用 Bing 進行文字生圖 | [hw10]( "游標顯示") |  |
| 11 | 變分自編碼器（VAE）開始的冒險旅程 | 用 Fooocus 來創作！ | [hw11]( "游標顯示") |  |
